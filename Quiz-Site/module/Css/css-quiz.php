...
<body>
    ...
    <main>
        ...
        <div class="container mt-3">
            <div class="row  ">
                <div class="col pt-3">
                    <p class="h6 f-2 fw-bold">Css Quiz</p>
                </div>
                        ...
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                ...
                                <label class="form-check-label w-100 m-hover" for="ans-2-1">
                                    <<span class="d-none">.</span>stylesheet>mystyle.css<<span>.</span>/stylesheet>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                ...
                                <label class="form-check-label w-100 m-hover" for="ans-2-2">
                                    <<span class="d-none">.</span>link rel="stylesheet" type="text/css"
                                        href="mystyle.css">
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                ...
                                <label class="form-check-label w-100 m-hover" for="ans-2-3">
                                    <<span class="d-none">.</span>style src="mystyle.css">
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col col-md-6">
                    <div class="card mb-3">
                        ...
                        <div class="card-footer">
                            <div class="row ">
                                <div class="col-12 col-lg-5 mb-2"><a href="css-answer.php"
                                        class="btn btn-success">Correct answers</a></div>
                                <div class="col-12 col-lg-3 mb-2"><a href="../../index-1.php" class="btn btn-primary">Try Again</a>
                                </div>
