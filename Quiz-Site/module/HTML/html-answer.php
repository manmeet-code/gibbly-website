...
<head>
    ...
    <title>HTML Quiz Answers | Gibbly</title>
...
<body>
    ...
    <main>
        ...
        <div class="container mt-3">
            <div class="row">
                <div class="col pt-3">
                    <p class="h6 f-2 fw-bold">HTML Quiz Answers</p>
                </div>
        ...
        <div class="container mt-4">
            ...
            <div class="card mb-3" id="quiz-2">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-2" id="ans-2-3" checked>
            ...
            <div class="card mb-3" id="quiz-3">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-3" id="ans-3-4" disabled>
            ...
            <div class="card mb-3" id="quiz-6">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-6" id="ans-6-4" checked>
            ...
            <div class="card mb-3" id="quiz-9">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-9" id="ans-9-4" disabled>
            ...
            <div class="card mb-3" id="quiz-10">
                ...
                <div class="card-footer text-center">
                    <div class="row">
                        <div class="col-12 col-md-6 mb-2"><a href="html-quiz.php" class="btn btn-primary">Try Again</a>
                        </div>
