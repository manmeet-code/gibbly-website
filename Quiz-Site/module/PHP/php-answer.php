...
<head>
    ...
    <title>PHP Quiz Answers | Gibbly</title>
...
<body>
    ...
    <main>
        <div class="container mt-3">
            <div class="row  ">
                <div class="col pt-3">
                    <p class="h6 f-2 fw-bold">PHP Quiz Answers</p>
                </div>
        ...
        <div class="container mt-5">
            ...
            <div class="card mb-3" id="quiz-1">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-1" id="ans-1-1" checked>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-1" id="ans-1-3" disabled>
            ...
            <div class="card mb-3" id="quiz-2">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-2" id="ans-2-4" disabled>
            ...
            <div class="card mb-3" id="quiz-3">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-3" id="ans-3-2" checked>
            ...
            <div class="card mb-3" id="quiz-4">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-4" id="ans-4-1" checked>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-4" id="ans-4-3" disabled>
            ...
            <div class="card mb-3" id="quiz-5">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-5" id="ans-5-3" checked>
            ...
            <div class="card mb-3" id="quiz-7">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-7" id="ans-7-1" checked>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-7" id="ans-7-2" disabled>
            ...
            <div class="card mb-3" id="quiz-8">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-8" id="ans-8-1" checked>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-8" id="ans-8-3" disabled>
            ...
            <div class="card mb-3" id="quiz-9">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-9" id="ans-9-2" checked>
            ...
            <div class="card mb-3" id="quiz-10">
                ...
                <div class="card-footer text-center">
                    <div class="row">
                        <div class="col-12 col-md-6 mb-2"><a href="php-quiz.php" class="btn btn-primary">Try Again</a>
                        </div>
