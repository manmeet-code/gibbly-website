...
<head>
    ...
    <title>Java Answer | Gibbly</title>
            ...
            <div class="container mt-5">
                ...
                <div class="card mb-3" id="quiz-1">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <div class="shadow-none p-3 mb-1 bg-light rounded">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ans-1" id="ans-1-4" checked>
                ...
                <div class="card mb-3" id="quiz-4">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <div class="shadow-none p-3 mb-1 bg-light rounded">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ans-4" id="ans-4-4" checked>
                ...
                <div class="card mb-3" id="quiz-7">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <div class="shadow-none p-3 mb-1 bg-light rounded">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ans-7" id="ans-7-3" checked>
                ...
                <div class="card mb-3" id="quiz-8">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <div class="shadow-none p-3 mb-1 bg-light rounded">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="ans-8" id="ans-8-2" checked>
                ...
                <div class="card mb-3" id="quiz-10">
                    ...
                    <div class="card-footer text-center">
                        <div class="row">
                            <div class="col-12 col-md-6 mb-2"><a href="java-quiz.php" class="btn btn-primary">Try Again</a>
                            </div>
