...
<head>
    ...
    <title>JavaScript Answer | Gibbly</title>
    ...
    <main>
        ...
        <div class="container mt-5">
            ...
            <div class="card mb-3" id="quiz-1">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-1" id="ans-1-4" disabled>
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" id="ans-btn-1">Next Quiz<span style="margin-left: 5px;"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                </div>
            </div>
            <!--End Quiz 01-->
            ...
            <div class="card mb-3" id="quiz-2">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-2" id="ans-2-1" checked>
                                <label class="form-check-label w-100 m-hover" for="ans-2-1">
                                    Both the <<span class="d-none">.</span>head> section and the <<span class="d-none">.</span>body> section are correct
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-2" id="ans-2-2" disabled>
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" id="ans-btn-2">Next Quiz<span style="margin-left: 5px;"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                </div>
            </div>
            <!--End Quiz 02-->
            ...
            <div class="card mb-3" id="quiz-3">
                ...
                <div class="card-body">
                    <h6 class="card-title">What is the correct syntax for referring to an external script called "xxx.js"?</h6>
                    <!--Anser 01-->
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-3" id="ans-3-1" disabled>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-3" id="ans-3-3" checked>
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" id="ans-btn-3">Next Quiz<span style="margin-left: 5px;"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                </div>
            </div>
            <!--End Quiz 03-->
            ...
            <div class="card mb-3" id="quiz-4">
                ...
                <div class="card-body">
                    <h6 class="card-title">The external JavaScript file must contain the <<span class="d-none">.</span>script> tag.</h6>
                    <!--Anser 01-->
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-4" id="ans-4-2" checked>
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" id="ans-btn-4">Next Quiz<span style="margin-left: 5px;"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                </div>
            </div>
            <!--End Quiz 04-->
            ...
            <div class="card mb-3" id="quiz-5">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-5" id="ans-5-2" checked>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-5" id="ans-5-4" disabled>
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" id="ans-btn-5">Next Quiz<span style="margin-left: 5px;"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                </div>
            </div>
            <!--End Quiz 05-->
            ...
            <div class="card mb-3" id="quiz-6">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-6" id="ans-6-1" disabled>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-6" id="ans-6-2" checked>
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" id="ans-btn-6">Next Quiz<span style="margin-left: 5px;"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                </div>
            </div>
            <!--End Quiz 06-->
            ...
            <div class="card mb-3" id="quiz-7">
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" id="ans-btn-7">Next Quiz<span style="margin-left: 5px;"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                </div>
            </div>
            <!--End Quiz 07-->
            ...
            <div class="card mb-3" id="quiz-8">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-8" id="ans-8-4" disabled>
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" id="ans-btn-8">Next Quiz<span style="margin-left: 5px;"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                </div>
            </div>
            <!--End Quiz 08-->
            ...
            <div class="card mb-3" id="quiz-9">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-9" id="ans-9-1" disabled>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-9" id="ans-9-4" checked>
                ...
                <div class="card-footer text-end">
                    <button class="btn btn-success" id="ans-btn-9">Next Quiz<span style="margin-left: 5px;"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
                </div>
            </div>
            <!--End Quiz 09-->
            ...
            <div class="card mb-3" id="quiz-10">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-10" id="ans-10-1" disabled>
                    ...
                    <div>
                        <div class="shadow-none p-3 mb-1 bg-light rounded">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ans-10" id="ans-10-4" checked>
                ...
                <div class="card-footer text-center">
                    <div class="row">
                        <div class="col-12 col-md-6 mb-2"><a href="javascript-quiz.php" class="btn btn-primary">Try Again</a>
                        </div>
                        <div class="col-12 col-md-6"><a href="../../index-1.php" class="btn btn-warning">Back to Quizzes</a></div>
                    </div>
                </div>
            </div>
            <!--End Quiz 10-->
